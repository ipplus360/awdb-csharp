...
namespace AiWen.Db
{
    ...
    /// <summary>
    ///     Given a AiWen DB file, this class will retrieve information about an IP address
    /// </summary>
    public sealed class Reader : IDisposable
    {
        ...
        {
            0xAB, 0xCD, 0xEF, 105, 112, 112, 108, 117, 115, 51, 54,48, 46,99,111,
            109
        };
        ...
        ///     Initializes a new instance of the <see cref="Reader" /> class.
        /// </summary>
        /// <param name="file">The AiWen DB file.</param>
        ...
        private T ResolveDataPointer<T>(int pointer, InjectableValues? injectables, Network? network) where T : class
        {
            ...
            if (resolved >= _database.Length)
            {
                throw new InvalidDatabaseException(
                    "The AiWen Db file's search tree is corrupt: "
        ...
        private int FindMetadataStart()
        {
            ...
            throw new InvalidDatabaseException(
                $"Could not find a AiWen Db metadata marker in this file ({_fileName}). Is this a valid AiWen Db file?");
        }
